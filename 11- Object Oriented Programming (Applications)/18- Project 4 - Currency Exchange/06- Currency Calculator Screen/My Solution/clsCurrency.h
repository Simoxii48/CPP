...
public:
	...
	static float ConversionCalculation(clsCurrency C1, float Amount)
	{
		return Amount / C1.Rate();
	}

	static float ConversionCalculation(clsCurrency C1, clsCurrency C2, float Amount)
	{
		float toUsdConversion = Amount / C1.Rate();
		return toUsdConversion * C2.Rate();
	}
};